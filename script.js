...
const arabicBar = document.querySelector(".arabic-bar");
...
const arabLoading = document.getElementById("arabic-load");

window.addEventListener("DOMContentLoaded", () => {
  const languageBars = [
    { id: "english", name: "English", percent: 70 },
    { id: "danish", name: "Danish", percent: 60 },
    { id: "turkish", name: "Turkish", percent: 80 },
    { id: "arabic", name: "Arabic", percent: 15 },
  ];
